...
/*   Updated: 2022/05/15 17:52:33 by esylva           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_sprite_paint(t_data *data, int i, double start)
{
...
void	ft_rais_s(t_data *data, double start)
{
...
void	ft_cast_rays2_s(t_data *data, int i, double start, double end)
{
	i = W_PANEL / 2;
...
void	ft_cast_rays_s(t_data *data)
{
	int		i;
	double	start;
	double	end;
